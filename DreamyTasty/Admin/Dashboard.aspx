<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="DreamyTasty.Admin.Dashboard" %>
                        ...
                        <div class="col-md col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <h5> <%Response.Write(Session["category"]); %> </h5>
                                    <div>
                        ...
                        <div class="col-md col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <span class="text-c-pink f-w-600">Prodcts</span>
                                    <h5><%Response.Write(Session["product"]); %> </h5>
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                        ...
                        <div class="col-md col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <h5><%Response.Write(Session["order"]); %> </h5>
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                        ...
                        <div class="col-md col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <h5><%Response.Write(Session["delivered"]); %> </h5>
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                        ...
                        <div class="col-md col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <h5><%Response.Write(Session["pending"]); %> </h5>
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                        ...
                        <div class="col-md col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <h5><%Response.Write(Session["user"]); %> </h5>
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                        ...
                        <div class="col-md col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <span class="text-c-green f-w-600">Toal Value</span>
                                    <h5><%Response.Write(Session["soldAmount"]); %> </h5>
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                        ...
                        <div class="col-md col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <span class="text-c-yellow f-w-600">Messages</span>
